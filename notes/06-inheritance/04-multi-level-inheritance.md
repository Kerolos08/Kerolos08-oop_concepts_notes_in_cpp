...
Is creating a class hierarchy where a class is derived from another derived class — forming a *chain* of inheritance.
...
int main()
{
    clsDeveloper Dev1("8436734673963", "Kero", "xxxx", "me@gmail.com", "+20 3785282", "Developer", "Senior", 343000, "C++");
    Dev1.Print();
    return 0;
}
```
...
This is a **series** of **Inheritance** to **reuse** the code and **easily fixing or adding** something new to it **without** editing every single part just one edit for the **Base class** and we done.

**Person                          ⇒                      Employee                  ⇒               Developer**

![image.png](Multi%20Level%20Inheritance/d546fe9d-6b75-4c19-8c0b-c520c4b6363a.png)

## Summary

- It’s called **multilevel** because inheritance passes *through multiple levels* (grandparent → parent → child).
- It helps **reuse code** across several generations of classes.
- But you should use it carefully — too many levels can make the code complex and harder to maintain.
